...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-background py-12 md:py-20 lg:py-32">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="relative z-10 max-w-2xl text-center lg:text-left">
            <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5 text-xs md:text-sm font-semibold text-primary mb-6">
              <ShieldCheck className="h-4 w-4" />
              <span>Certified Healthcare Partner</span>
            </div>
            <h1 className="font-headline text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-secondary mb-6">
          ...
          <div className="relative lg:h-[500px] xl:h-[600px]">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-xl hidden xl:block border border-border">
      ...
      {/* Background blobs */}
      <div className="absolute top-0 right-0 -mr-24 -mt-24 h-96 w-96 rounded-full bg-accent/10 blur-3xl opacity-50" />
      <div className="absolute bottom-0 left-0 -ml-24 -mb-24 h-96 w-96 rounded-full bg-primary/10 blur-3xl opacity-50" />
    </section>
  )
}
